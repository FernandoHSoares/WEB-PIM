<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="localizacao.aspx.cs" Inherits="Site.Pages.localizacao" %>
...
<body>
  ...
  <header>
    <nav class="navbar">
      ...
      <ul class=" menu">
        <a class="nav-user-icon" runat="server" onserverclick="btnAreaCliente" ><img src="img/user.png" alt="img"></a>
  ...
  <div class="container-maps">
    <div class="box-maps">
      <p>Localização da Agência:</p>
      <img class="mapa" src="img/Login-Cliente-img/Localização ALUCAR final 2 1.png" alt="img">
    </div>
  </div>
